...
export default class Application extends EventEmitter {
    appName: string = "Server";                                                         // App name
    ...
    rpc: (serverId: string) => any = null as any;                                            // Rpc packaging
    rpcPool: RpcSocketPool = new RpcSocketPool();                                            // Rpc socket pool

    logger: (tag: string, level: loggerLevel, err: Error | string) => void = function () { };                      // Internal msg log output
